# MemoryLane: Frontend Hub 🎨

This directory contains the premium React-based frontend for **MemoryLane**. It is built with a focus on high-end aesthetics, fluid animations, and a seamless user experience.
...
2. **Configure Environment:**
   Create a `.env` file:
   ```env
   VITE_API_URL=https://memorylane-personal.onrender.com
